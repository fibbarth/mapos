            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal" >
					...
					<div class="control-group">
                        ...
                        <div class="controls">
                            <input id="porcentagem" class="valor_porcentagem" type="text" name="porcentagem" value="<?php echo $result->porcentagem * 100; ?>"  />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="precoVenda" class="money valor_porcentagem" type="text" name="precoVenda" value="<?php echo $result->precoVenda; ?>"  />
                        </div>
                    </div>
